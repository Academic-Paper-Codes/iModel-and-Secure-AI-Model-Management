...
public class Paillier {
    ...
    /**
     * @param k k is the security parameter, which decides
     ...
     * @throws Exception If the message is not in Z*_n, there is
     *                   an exception.
     * @Title: encrypt
     ...
     * @throws Exception If the cipher is not in Z*_(n^2), there is
     *                   an exception.
     * @Title: decrypt
    ...
    private static boolean belongToZStarNSquare(BigInteger c, BigInteger nsquare) {
        return c.compareTo(BigInteger.ZERO) >= 0 && c.compareTo(nsquare) < 0 && c.gcd(nsquare).intValue() == 1;
    }
/*
